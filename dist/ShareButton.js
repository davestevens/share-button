...
var ShareButton = (function (_ShareUtils) {
  ...
  _createClass(ShareButton, [{
    ...
    value: function _public(action) {
      ...
      if (typeof element === 'undefined') shareButton = document.getElementsByTagName('share-button');else shareButton = document.querySelectorAll(element);

      instances = _get(Object.getPrototypeOf(ShareButton.prototype), '_objToArray', this).call(this, shareButton);
    ...
    value: function _setup(element, opts) {
      ...
      if (typeof element === 'undefined') shareButton = document.getElementsByTagName('share-button');else shareButton = document.querySelectorAll('share-button' + element);
