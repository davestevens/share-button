...
var ShareButton = (function (_ShareUtils) {
  ...
  _createClass(ShareButton, [{
    ...
    value: function _defaultTitle() {
      ...
      if (content = document.querySelector('meta[property="og:title"]') || document.querySelector('meta[name="twitter:title"]')) return content.getAttribute('content');else if (content = document.querySelector('title')) return content.textContent;
    }
